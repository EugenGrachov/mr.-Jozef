...
Searching notes by content 📌 Adding tags to notes 🔎 Searching and sorting notes by tags
💾 Data Storage
...
python jozef.py
The program will start in the Command-Line Interface (CLI). You will see the available commands and functions.
Main commands:
Hello
